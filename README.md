...
用法同netmerge, 结果为netmerge的补集

Sample:

```bash
    php rnetmerge.php 0.0.0.0/1 128.0.0.0/1
    # (yes, nothing)

    php rnetmerge.php 0.0.0.0/1
    # 128.0.0.0/1

    php rnetmerge.php 128.0.0.0/1
    # 0.0.0.0/1

    php rnetmerge.php 192.168.0.0/16 172.16.0.0/12 10.0.0.0/8 169.254.0.0/16 100.64.0.0/10 127.0.0.0/8 224.0.0.0/4 0.0.0.0/32 255.255.255.255/32
    # 0.0.0.1/5
    # 8.0.0.1/8
    # 9.0.0.1/9
    # 9.128.0.1/10
